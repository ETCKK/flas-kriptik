...
export default function NavBar() {
    return (
        <nav className="fixed inset-x-3 top-3 z-40 border-2 border-surface bg-surface text-ink shadow-[6px_6px_0_var(--color-shadow)] md:inset-x-auto md:left-1/2 md:w-fit md:-translate-x-1/2">
            <div className="relative grid h-[4.25rem] grid-cols-[auto_1fr_auto] items-center gap-3 px-3 md:static md:grid-cols-[auto_auto_auto] md:gap-6 md:px-5">
                ...
                <div className="col-start-3 flex items-center justify-self-end text-ink">
                    <SettingsMenu />
                    <Link
                        href="/profil"
                        aria-label="Profil"
                        className="flex h-10 w-10 touch-manipulation items-center justify-center text-accent transition-colors duration-200 hover:bg-accent hover:text-surface"
                    >
